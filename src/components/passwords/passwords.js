...
export default class Passwords extends Component {
    ...
    render() {
        ...
        return (
            ...
            this.state.edit ? <div className="modal_add_password">

                {/*MODAL WINDOW FOR ADDING PASSWORD*/}
                ...
                <div className="passwords_container">
                    ...
                    <PasswordCard title="Mail password" login="user" password="1234567"
                    ...
                    <div className="add_password_button">
                        <button onClick={event => this.setState({edit: !this.state.edit})}>
